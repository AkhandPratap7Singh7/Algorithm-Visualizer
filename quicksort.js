...
$(document).ready(function(){
    ...
    $("#quick-f").click(function(){
        $(".chart-bar3").css("background-color",  "#00000");
...
function task4(time,i,j,swap){
    loop4 = setTimeout(function(){
        ...
        for(let m=0;m<=j;m++){
            if(m==i){
                $(".chart-bar3:nth-child("+(i+1)+")").css("background-color",  "red");
            }else if(m==j){
                $(".chart-bar3:nth-child("+(j+1)+")").css("background-color",  "green");
            }else{
                $(".chart-bar3:nth-child("+(m+1)+")").css("background-color",  "#00000");
            }
        }
